...
type (
	...
	// BilibiliUserHook is the signature for custom BilibiliUser hook methods
	BilibiliUserHook func(context.Context, boil.ContextExecutor, *BilibiliUser) error
...
var bilibiliUserAfterSelectHooks []BilibiliUserHook

var bilibiliUserBeforeInsertHooks []BilibiliUserHook
var bilibiliUserAfterInsertHooks []BilibiliUserHook

var bilibiliUserBeforeUpdateHooks []BilibiliUserHook
var bilibiliUserAfterUpdateHooks []BilibiliUserHook

var bilibiliUserBeforeDeleteHooks []BilibiliUserHook
var bilibiliUserAfterDeleteHooks []BilibiliUserHook

var bilibiliUserBeforeUpsertHooks []BilibiliUserHook
var bilibiliUserAfterUpsertHooks []BilibiliUserHook

// doAfterSelectHooks executes all "after Select" hooks.
func (o *BilibiliUser) doAfterSelectHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserAfterSelectHooks {
...
func (o *BilibiliUser) doBeforeInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserBeforeInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BilibiliUser) doAfterInsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserAfterInsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BilibiliUser) doBeforeUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserBeforeUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BilibiliUser) doAfterUpdateHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserAfterUpdateHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BilibiliUser) doBeforeDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserBeforeDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BilibiliUser) doAfterDeleteHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserAfterDeleteHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BilibiliUser) doBeforeUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserBeforeUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
func (o *BilibiliUser) doAfterUpsertHooks(ctx context.Context, exec boil.ContextExecutor) (err error) {
	if boil.HooksAreSkipped(ctx) {
		return nil
	}

	for _, hook := range bilibiliUserAfterUpsertHooks {
		if err := hook(ctx, exec, o); err != nil {
			return err
		}
	}
...
// AddBilibiliUserHook registers your hook function for all future operations.
func AddBilibiliUserHook(hookPoint boil.HookPoint, bilibiliUserHook BilibiliUserHook) {
	switch hookPoint {
	case boil.AfterSelectHook:
		bilibiliUserAfterSelectHooks = append(bilibiliUserAfterSelectHooks, bilibiliUserHook)
	case boil.BeforeInsertHook:
		bilibiliUserBeforeInsertHooks = append(bilibiliUserBeforeInsertHooks, bilibiliUserHook)
	case boil.AfterInsertHook:
		bilibiliUserAfterInsertHooks = append(bilibiliUserAfterInsertHooks, bilibiliUserHook)
	case boil.BeforeUpdateHook:
		bilibiliUserBeforeUpdateHooks = append(bilibiliUserBeforeUpdateHooks, bilibiliUserHook)
	case boil.AfterUpdateHook:
		bilibiliUserAfterUpdateHooks = append(bilibiliUserAfterUpdateHooks, bilibiliUserHook)
	case boil.BeforeDeleteHook:
		bilibiliUserBeforeDeleteHooks = append(bilibiliUserBeforeDeleteHooks, bilibiliUserHook)
	case boil.AfterDeleteHook:
		bilibiliUserAfterDeleteHooks = append(bilibiliUserAfterDeleteHooks, bilibiliUserHook)
	case boil.BeforeUpsertHook:
		bilibiliUserBeforeUpsertHooks = append(bilibiliUserBeforeUpsertHooks, bilibiliUserHook)
	case boil.AfterUpsertHook:
		bilibiliUserAfterUpsertHooks = append(bilibiliUserAfterUpsertHooks, bilibiliUserHook)
	}
}
...
func (q bilibiliUserQuery) All(ctx context.Context, exec boil.ContextExecutor) (BilibiliUserSlice, error) {
	...
	if len(bilibiliUserAfterSelectHooks) != 0 {
		for _, obj := range o {
...
func FindBilibiliUser(ctx context.Context, exec boil.ContextExecutor, uID int64, selectCols ...string) (*BilibiliUser, error) {
	...
	if err = bilibiliUserObj.doAfterSelectHooks(ctx, exec); err != nil {
		return bilibiliUserObj, err
	}
...
func (o BilibiliUserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if len(bilibiliUserBeforeDeleteHooks) != 0 {
		for _, obj := range o {
	...
	if len(bilibiliUserAfterDeleteHooks) != 0 {
		for _, obj := range o {
